			                ...
			                <div class="row">
					            <div class="col-md-12">
					                ...
					                <div class="table-responsive">
					                    <div class="header">
					                       <div class="col-md-4">
						                       <a class="addNew btn btn-info" href="/newCustomer">Add New Customer</a>
						                   </div>
						                   <div class="col-md-4">
						                   </div>
						                   <%-- <div class="col-md-4">
					                    ...
					                    <div class="content">
					                        <table class="table table-bordered table-striped table-hover table-responsive">
					                            ...
					                            <tbody>
					                               <c:forEach items="${customerList}" var="customerList" varStatus="theNumber">
														<tr align="center">
															<td>${theNumber.index+1}</td>
															<td>${customerList.firstName}</td>
															<td>${customerList.lastName}</td>
															<td>
																 <form action="/deleteCustomer/${customerList.id}" method="post">
																  	<button type="button" class="btn btn-warning icon-edit" onclick="location.href = '/editCustomer/${customerList.id}';" style="width: 100px;">Edit</button>
